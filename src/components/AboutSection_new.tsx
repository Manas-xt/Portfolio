...
const techStack = [
  { name: "Linux/RedHat", level: 95, emoji: "🐧" },
  { name: "Development", level: 88, emoji: "💻" },
  { name: "DevOps", level: 82, emoji: "🔧" },
  { name: "Cloud Tech", level: 78, emoji: "☁️" },
  { name: "DSA", level: 85, emoji: "🧮" },
  { name: "Always Learning", level: 100, emoji: "📚" }
]
  ...
  return (
    <section className="min-h-screen py-20 px-6 bg-gradient-to-br from-gray-900 via-gray-800 to-black relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        {/* Tech Stack with Fun Progress Bars */}
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
            ...
            {techStack.map((tech, index) => (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="font-medium text-white font-outfit flex items-center gap-2">
